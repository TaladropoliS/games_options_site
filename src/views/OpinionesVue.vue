<template>
  <div class="opiniones">
    ...
    <div class="container">
      ...
      <div v-for="(opinion, idOpinion) in opiniones" :key="idOpinion">
          ...
          <div class="accordion mb-3" id="accordion"
            ...
            <div class="accordion-item">
              ...
              <h2 class="accordion-header" :id="`headingOne${opinion.idOpinion}`">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" :data-bs-target="`#collapseOne${opinion.idOpinion}`"
                        aria-expanded="true" aria-controls="collapseOne">
                  <span>Opinion de: <b>{{ opinion.nombre }}</b></span>&nbsp;para el JUEGO&nbsp;<b>{{ game.name }}</b>
                </button>
              </h2>

              <div :id="`collapseOne${opinion.idOpinion}`" class="accordion-collapse collapse show" :aria-labelledby="`headingOne${opinion.idOpinion}`"
